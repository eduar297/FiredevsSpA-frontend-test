...
const headCells = [
  ...
  { id: "id", numeric: true, disablePadding: false, label: "id" },
  {
    ...
    label: "Nombre del profesor guia",
  },
  {
    id: "edit",
    numeric: true,
...
const EnhancedTableToolbar = ({ setOpenFormGroup, setCreate, ...props }) => {
...
export default function GroupTable({ groups, professors, dispatch }) {
  ...
  const [openFormGroup, setOpenFormGroup] = React.useState(false);
